...
# Make a list of each chacater in the input string
...
while True:
    ...
    # If accep is the next action print the input_list, stack and 'accept'. Finish the program
    ...
    # If the next state is a transition, 
        ...
        # Print the input_list, stack with next state
        print(input_list, states_stack, next_state)
    ...
    # If it is a reduction
        ...
        # Print the input_list, states stack with the genetared string of reduction
        ...
        if pop_amount>1:
            ...
            for _ in range(move_i_places):
                # We have to remove numer of move_i_places chacaters from the input list
                input_list.pop(i-1)
        ...
        # Replace in i-1 the string it has for the non-terminal symbol
        input_list[i-1] = new 
